...
void ShaderCallback::OnSetConstants(irr::video::IMaterialRendererServices * services, irr::s32 userData)
{
    ...
    services->setPixelShaderConstant("ShadowMap", (float*)(&index[0]), 1);
    services->setPixelShaderConstant("topTex0",  (float*)(&index[1]), 1);
    services->setPixelShaderConstant("sideTex0",  (float*)(&index[2]), 1);
    services->setPixelShaderConstant("topTex1",  (float*)(&index[3]), 1);
    services->setPixelShaderConstant("sideTex1",  (float*)(&index[4]), 1);
    services->setPixelShaderConstant("topTex2",  (float*)(&index[5]), 1);
    services->setPixelShaderConstant("sideTex2",  (float*)(&index[6]), 1);
    services->setPixelShaderConstant("topTex3",  (float*)(&index[7]), 1);
    services->setPixelShaderConstant("sideTex3",  (float*)(&index[8]), 1);
